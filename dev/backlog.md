...
| # | Item | Resolved in |
|---|---|---|
| — | BLS detection always `true` | Fixed: `rc == 0` in collect-vm-info.yml |
| — | sudo not found on SLES 16 | Fixed: `find -maxdepth 1` in collect-vm-info.yml |
| — | SUSE EFI classifier shows `full_standalone` | Fixed: Added `source` detection in collect-vm-info.yml |
